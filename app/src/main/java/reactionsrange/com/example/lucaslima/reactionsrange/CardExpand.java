...
public class CardExpand extends LinearLayout {
    ...
    public static interface OnExpandListener {
        public void onToggle(CardExpand view, View child, boolean isExpanded);

        public void onExpandOffset(CardExpand view, View child,
